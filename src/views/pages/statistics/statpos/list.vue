        ...
        <div class="content-list-wrap" flex="dir:top" flex-box="1">
            ...
            <div class="table-wrap" flex-box="1" v-if="chartType === '2'">
                <el-table :data="tableData" v-if="refresh" class="table-border" ref="multipleTable" height="100%" :summary-method="getSummaries" show-summary>
                    ...
                    <!-- <el-table-column prop="ydSmsNum" label="短信数" width=""></el-table-column> -->
...
export default {
	...
	methods:{
        ...
        exoprtList(){
            window.location.href=process.env.VUE_APP_APR + '/downloadSmsStatist?downType=6';
        },
        searchList(){
        ...
        queryChartData(){
            this.$api.statistPlaceOfDate({...this.formInline}).then( res => {
		...
		queryList(){
            ...
            this.tableData = []
            this.refresh = false
			this.$api.statistPlaceOfDate({...this.formInline,page:this.page}).then( res => { 
